	...
	if(Uart_Receive_flag)
	{
		...
		switch(RX1_Buffer[4])
		{
			...
			case 0x03:
				...
				if(RX1_Buffer[8]==0x02){Data_Encapsulation(Mcu_send,14,0x04,Sn,0x03);}
				break;	
			//MCU主动上报当前状态WIFI模组回复
			case 0x06:	
				break;
			...
			case 0x0d:
				...
				break;
			case 0x0f:
				Data_Encapsulation(Mcu_send,9,0x10,Sn,0x00);
				break;
			//WiFi模组非法数据包通知
			case 0x11:
				Data_Encapsulation(Mcu_send,10,0x12,Sn,RX1_Buffer[8]);
				break;			
